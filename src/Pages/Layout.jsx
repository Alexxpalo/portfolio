...
function Layout() {
    return (
        ...
        <h1 className='text-white text-3xl text-bold tracking-wide'>&gt;Alexander@Palosaari/Portfolio</h1>
        <h1 className='text-white text-3xl text-bold tracking-wide animate-blink'>_</h1>
        </div>
        <Outlet />
        <div className="bg-blue-500 w-full pt-5 flex mt-10 justify-around">
